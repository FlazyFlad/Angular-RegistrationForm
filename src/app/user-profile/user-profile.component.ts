...
export class UserProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // });
    this.route.params.subscribe(params => {
      this.userId = params['userId']; // Получаем userId из URL
      console.log(this.userId)
      // Получите данные пользователя из сервиса UserService
  ...
  saveChanges() {
    ...
    // Обновите данные пользователя через сервис UserService
